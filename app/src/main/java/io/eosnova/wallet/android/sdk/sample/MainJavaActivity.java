    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.stake).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NovaAuth.INSTANCE.requestStake(MainJavaActivity.this, stake, callback);
            }
        });
        ...
        findViewById(R.id.transcation).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NovaAuth.INSTANCE.requestTransaction(MainJavaActivity.this, list, callback);
            }
        });
        ...
        findViewById(R.id.signature).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NovaAuth.INSTANCE.requestSignature(MainJavaActivity.this, signature, callback);
            }
        });
